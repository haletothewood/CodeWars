...
The strings can contain alpha and beta in any case (e.g. "Alpha", 
"BeTa"). The input will be an array containing strings and 
nils. The output should be an array containing :alpha, :beta and 
:unknown symbols, based on the string at that index in the 
input array.
...
puts line_types(["Alpha", "beta", nil, "unknown"])
